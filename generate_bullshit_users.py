...
def createUsers():
	...
	while (i < 500):
		...
		query = {'Pref': '1', 'Verify': '1', 'Matches': '', 'Chats' : '', 'NewMessage': '', 'Likes': '', 'Dislikes': '', 'Name': name, 'Surname': surname, 'Age': age, 'Email': email, 'username': username, 'Password': hash_password('Password123!'), 
